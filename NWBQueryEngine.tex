...
Based on the usage of HDF5 (Section \ref{HDF5}) as a core format for the NWB format (Section \ref{nwb}), and definition of data types (Section \ref{data-types}) and (Section \ref{typical-data-analysis-steps}) the requirements for the NWB query engine are defined.  \ref{DataJoint} 
