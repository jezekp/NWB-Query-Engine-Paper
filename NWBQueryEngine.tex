...
From the implementation point of view the HDF5 data format is used. HDF5 formats provide following primitives to represent data:
...
\begin{itemize}
 ...
 \item Dataset - Is a representation of stored raw data. It is implmenented as a multidimensional array 
 \item Attribute - Attribute is a key-value representation that can suplement a group or a dataset by metadata
\end{itemize}
