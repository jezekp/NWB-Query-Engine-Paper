...
Many approaches are in preliminary implementation or do not provide a satisfactory application interface. On the other hand, many of them are focused only on a specific purposes of a single laboratory. To address these issues and provide a standard format for neurophysiology data, the Neurodata Without Borders Cellular Neurophysiology (NWB:CN or just NWB) format was developed \citep{teeters-neuron}. 
